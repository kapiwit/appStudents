                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12 mb-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" name="firstName" type="text" placeholder="uzupełnij imię">
                                        </div>
                            </div>
                            <div class="form-group row">
                                <label  class="col-2 col-form-label">Nazwisko</label>
                                <div class="col-10">
                                    <input class="form-control" name="lastName" type="text" placeholder="uzupełnij nazwisko">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" name="github" type="text" placeholder="uzupełnij url do gita">
                                </div>
                            </div>
